...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cmsplugin_filer_image_thumbnailoption', 'crop', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'ThumbnailOption.upscale'
        db.add_column('cmsplugin_filer_image_thumbnailoption', 'upscale', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'FilerImage.crop'
        db.add_column('cmsplugin_filerimage', 'crop', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'FilerImage.upscale'
        db.add_column('cmsplugin_filerimage', 'upscale', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'FilerImage.css_class'
        db.add_column('cmsplugin_filerimage', 'css_class', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Changing field 'FilerImage.use_autoscale'
        db.alter_column('cmsplugin_filerimage', 'use_autoscale', self.gf('django.db.models.fields.BooleanField')(blank=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'FilerImage.css_class'
        db.delete_column('cmsplugin_filerimage', 'css_class')

        # Changing field 'FilerImage.use_autoscale'
        db.alter_column('cmsplugin_filerimage', 'use_autoscale', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'cmsplugin_filer_image.filerimage': {
            ...
            'crop': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
            ...
            'upscale': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
            'use_autoscale': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'width': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        'cmsplugin_filer_image.thumbnailoption': {
            'Meta': {'object_name': 'ThumbnailOption'},
            'crop': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
