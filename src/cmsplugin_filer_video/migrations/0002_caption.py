...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FilerVideo.column_width'
        db.add_column('cmsplugin_filervideo', 'column_width', self.gf('django.db.models.fields.CharField')(default='100', max_length=6, null=True, blank=True), keep_default=False)

        # Adding field 'FilerVideo.caption'
        db.add_column('cmsplugin_filervideo', 'caption', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FilerVideo.column_width'
        db.delete_column('cmsplugin_filervideo', 'column_width')

        # Deleting field 'FilerVideo.caption'
        db.delete_column('cmsplugin_filervideo', 'caption')
    ...
    models = {
        ...
        'cmsplugin_filer_video.filervideo': {
            ...
            'image': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'filer_video_image'", 'blank': 'True', 'null': 'True', 'to': "orm['filer.Image']"}),
